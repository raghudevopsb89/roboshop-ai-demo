...
ask_raw.py and ask_rag.py each show one half, so the contrast is split across
two scrollbacks; here the ungrounded answer and the grounded one sit directly
